...
export var getDayGrid = function (options) {
    ...
    var selectedDateRangeType = getDateRangeTypeToUse(dateRangeType, workWeekDays);
    var selectedDates = getDateRangeArray(selectedDate, selectedDateRangeType, firstDayOfWeek, workWeekDays, daysToSelectInDayView);
