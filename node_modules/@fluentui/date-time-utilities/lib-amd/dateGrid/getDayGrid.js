define(["require", "exports", "../dateMath/dateMath", "../dateValues/dateValues", "./getDateRangeTypeToUse", "./getBoundedDateRange", "./isRestrictedDate"], function (require, exports, dateMath_1, dateValues_1, getDateRangeTypeToUse_1, getBoundedDateRange_1, isRestrictedDate_1) {
    ...
    exports.getDayGrid = function (options) {
        var selectedDate = options.selectedDate, dateRangeType = options.dateRangeType, firstDayOfWeek = options.firstDayOfWeek, today = options.today, minDate = options.minDate, maxDate = options.maxDate, weeksToShow = options.weeksToShow, workWeekDays = options.workWeekDays, daysToSelectInDayView = options.daysToSelectInDayView, restrictedDates = options.restrictedDates;
        ...
        var selectedDateRangeType = getDateRangeTypeToUse_1.getDateRangeTypeToUse(dateRangeType, workWeekDays);
        var selectedDates = dateMath_1.getDateRangeArray(selectedDate, selectedDateRangeType, firstDayOfWeek, workWeekDays, daysToSelectInDayView);
