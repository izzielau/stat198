...
export var NavFabricDemoAppExample = function () {
    return (React.createElement(Nav, { styles: navStyles, ariaLabel: "Nav example similiar to one found in this demo page", groups: navLinkGroups }));
};
