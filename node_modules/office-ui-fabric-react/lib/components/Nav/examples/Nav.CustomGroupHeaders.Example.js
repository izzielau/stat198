...
export var NavCustomGroupHeadersExample = function () {
    return (React.createElement(Nav, { onRenderGroupHeader: _onRenderGroupHeader, ariaLabel: "Nav example with custom group headers", groups: navLinkGroups }));
};
