...
var CommandBarLazyExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/CommandBar/examples/CommandBar.Lazy.Example.tsx');
export var CommandBarPageProps = {
    ...
    examples: [
        ...
        },
        {
            ...
            view: React.createElement(CommandBarLazyExample, null),
        },
    ],
