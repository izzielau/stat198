...
export var CommandBarBasicExample = function () {
    return (React.createElement("div", null,
        React.createElement(CommandBar, { items: _items, overflowItems: _overflowItems, overflowButtonProps: overflowProps, farItems: _farItems, ariaLabel: "Use left and right arrow keys to navigate between commands" })));
};
var _items = [
    {
        key: 'newItem',
