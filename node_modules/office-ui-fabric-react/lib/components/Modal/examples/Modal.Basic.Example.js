...
import { getTheme, mergeStyleSets, FontWeights, ContextualMenu, Toggle, DefaultButton, Modal, IconButton, } from 'office-ui-fabric-react';
var dragOptions = {
...
export var ModalBasicExample = function () {
    ...
    return (React.createElement("div", null,
        React.createElement(Toggle, { styles: toggleStyles, label: "Is draggable", inlineLabel: true, onChange: toggleIsDraggable, checked: isDraggable }),
        React.createElement(DefaultButton, { onClick: showModal, text: "Open Modal" }),
        React.createElement(Modal, { titleAriaId: titleId, isOpen: isModalOpen, onDismiss: hideModal, isBlocking: false, containerClassName: contentStyles.container, dragOptions: isDraggable ? dragOptions : undefined },
