...
var BorderBlindsIcon = function (props) {
    ...
    return (React.createElement(FontIcon, { iconName: "borderblinds-svg", className: mergeStyles(iconClass, {
            width: 50,
            height: 50,
            selectors: {
                '.borderblinds-part1': {
...
export var IconSvgExample = function () {
    // FontIcon is an optimized variant of standard Icon.
    // You could also use the standard Icon here.
    return (React.createElement("div", null,
        React.createElement(FontIcon, { iconName: "onedrive-svg", className: iconClass }),
        React.createElement(FontIcon, { iconName: "yammer-svg", className: mergeStyles(iconClass, {
                fill: 'red',
                selectors: {
                    '.thing': {
                        fill: 'green',
