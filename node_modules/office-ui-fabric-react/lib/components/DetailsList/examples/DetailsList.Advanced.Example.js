...
var DetailsListAdvancedExample = /** @class */ (function (_super) {
    ...
    DetailsListAdvancedExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classNames.root },
            React.createElement(CommandBar, { styles: commandBarStyles, items: this._getCommandItems(canResizeColumns, checkboxVisibility, constrainMode, isHeaderVisible, isLazyLoaded, layoutMode, selectionMode), farItems: [{ key: 'count', text: this.state.selectionCount + " selected" }] }),
