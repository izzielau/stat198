define(["require", "exports", "react", "office-ui-fabric-react/lib/Icon", "office-ui-fabric-react/lib/Styling"], function (require, exports, React, Icon_1, Styling_1) {
    ...
    var BorderBlindsIcon = function (props) {
        var _a = props.color1, color1 = _a === void 0 ? 'red' : _a, _b = props.color2, color2 = _b === void 0 ? 'green' : _b, _c = props.color3, color3 = _c === void 0 ? 'blue' : _c;
        // FontIcon is an optimized variant of standard Icon.
        // You could also use the standard Icon here.
        return (React.createElement(Icon_1.FontIcon, { iconName: "borderblinds-svg", className: Styling_1.mergeStyles(iconClass, {
                width: 50,
                height: 50,
                selectors: {
                    '.borderblinds-part1': {
    ...
    exports.IconSvgExample = function () {
        // FontIcon is an optimized variant of standard Icon.
        // You could also use the standard Icon here.
        return (React.createElement("div", null,
            React.createElement(Icon_1.FontIcon, { iconName: "onedrive-svg", className: iconClass }),
            React.createElement(Icon_1.FontIcon, { iconName: "yammer-svg", className: Styling_1.mergeStyles(iconClass, {
                    fill: 'red',
                    selectors: {
                        '.thing': {
                            fill: 'green',
            ...
            React.createElement(BorderBlindsIcon, { color3: "pink" })));
    };
});
