    ...
    exports.LinkBasicExample = function () {
        return (React.createElement("div", null,
            React.createElement("p", null,
                ...
                ' ',
                React.createElement(Link_1.Link, { href: "https://developer.microsoft.com/en-us/fluentui#/controls/web/link" }, "it renders as an anchor tag."),
                ' ',
                "Without an href, ",
                React.createElement(Link_1.Link, null, "the link is rendered as a button"),
                ". You can also use the disabled attribute to create a",
                ' ',
                React.createElement(Link_1.Link, { disabled: true, href: "https://developer.microsoft.com/en-us/fluentui#/controls/web/link" }, "disabled link.")),
