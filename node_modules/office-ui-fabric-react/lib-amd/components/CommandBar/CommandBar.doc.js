define(["require", "exports", "react", "./examples/CommandBar.Basic.Example", "./examples/CommandBar.ButtonAs.Example", "./examples/CommandBar.CommandBarButtonAs.Example", "./examples/CommandBar.SplitDisabled.Example", "./examples/CommandBar.Lazy.Example"], function (require, exports, React, CommandBar_Basic_Example_1, CommandBar_ButtonAs_Example_1, CommandBar_CommandBarButtonAs_Example_1, CommandBar_SplitDisabled_Example_1, CommandBar_Lazy_Example_1) {
    "use strict";
    ...
    exports.CommandBarPageProps = {
        ...
        examples: [
            ...
            },
            {
                ...
                view: React.createElement(CommandBar_Lazy_Example_1.CommandBarLazyExample, null),
            },
        ],
