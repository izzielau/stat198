define(["require", "exports", "tslib", "react", "react-dom", "../../Utilities", "./DetailsList.types", "../../FocusZone", "../../Icon", "../../Layer", "../GroupedList/GroupSpacer", "../../GroupedList", "./DetailsRowCheck", "../../utilities/selection/interfaces", "../../utilities/dragdrop/index", "../../components/DetailsList/DetailsColumn", "./DetailsHeader.types"], function (require, exports, tslib_1, React, react_dom_1, Utilities_1, DetailsList_types_1, FocusZone_1, Icon_1, Layer_1, GroupSpacer_1, GroupedList_1, DetailsRowCheck_1, interfaces_1, index_1, DetailsColumn_1, DetailsHeader_types_1) {
    ...
    var DetailsHeaderBase = /** @class */ (function (_super) {
        ...
        DetailsHeaderBase.prototype.render = function () {
            ...
            return (React.createElement(FocusZone_1.FocusZone, { role: "row", "aria-label": ariaLabel, className: classNames.root, componentRef: this._rootComponent, ref: this._onRootRef, onMouseMove: this._onRootMouseMove, "data-automationid": "DetailsHeader", direction: FocusZone_1.FocusZoneDirection.horizontal },
                showCheckbox
                    ? [
