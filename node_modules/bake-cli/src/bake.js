...
var Bake = function (_CLI) {
  ...
  function Bake(filename) {
    var opts = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

    _classCallCheck(this, Bake);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Bake).call(this, opts));
    ...
    _this.debug('Bake init CLI with %s options', Object.keys(opts).join(' '));

    _this.bakefile = filename;
    ...
    if (!filename) {
      ...
      _this.info('Run "bake init" to generate a Makefile.');
      return _possibleConstructorReturn(_this);
    }
