...
var Template = function (_CLI) {
  ...
  _createClass(Template, [{
    ...
    key: 'directories',
    get: function get() {
      return [_path2.default.join(this.home, '.config/bake/templates'), _path2.default.join(this.home, '.bake/templates'), _path2.default.join(__dirname, '../templates')];
    }
  }]);
